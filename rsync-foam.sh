...
echo "2214 --> archive"
rsync --verbose --recursive --times --update --omit-dir-times --prune-empty-dirs --include="*/" --exclude="*.png" --exclude="*.mp4" --exclude="*.?if" --exclude="*.ORSSession" ~/2214/"$folder"/ ~/research_storage_uct/Archiv_Tape/"$folder"/
