...
echo "2214 --> archive"
rsync $options --exclude="*.png" --exclude="*.mp4" --exclude="*_rectmp.log" ~/2214/"$folder"/ ~/research_storage_uct/Archiv_Tape/"$folder"/
...
echo "Archive Dragonfly sessions"
rsync $options --include="*.ORSSession" --exclude="*" /media/habi/Fast_SSD/"$folder"/ ~/research_storage_uct/Archiv_Tape/"$folder"/
rsync $options --include="*.ORSSession" --exclude="*" ~/anaklin04-f/"$folder"/ ~/research_storage_uct/Archiv_Tape/"$folder"/
